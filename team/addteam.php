...
if(!empty($_POST)){
  ...
  if(empty($error)){
    $_SESSION['team'] = $_POST;
    header('Location: addteamcheck.php');
    exit();
  }
}
...
<form action="" method="post" enctype="multipart/form-data">
  <dl>
    <dt>追加チーム名<font color="red">　必須</font></dt>
    <dd>
      <input type="text" name="team" size="20" maxlength="20"  value="<?php echo htmlspecialchars($team, ENT_QUOTES, 'UTF-8'); ?>">
      <?php if(!empty($error['team']) && $error['team'] == 'blank'): ?>
        <p><font color="red">* チーム名を入力してください</font></p>
      <?php endif; ?>
    </dd>
